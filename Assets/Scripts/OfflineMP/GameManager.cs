...
public class GameManager : MonoBehaviour
{
    ...
    public IEnumerator NextTurn()
    {
        ...
        if (GetCurrentPlayer() == "black")
        {
            ...
            ChessPiece caller = null;
            for (int i = 0; i < 8; i++)
            {
                if (GetPosition(i, 0) != null && GetPosition(i, 0).name == "blackPawn") caller = GetPosition(i, 0).GetComponent<ChessPiece>();
            }
            ...
            if (caller != null)
            {
                ...
                bbishopImg.gameObject.GetComponent<RectTransform>().anchoredPosition += new Vector2(5000f, 0f);
                brookImg.gameObject.GetComponent<RectTransform>().anchoredPosition += new Vector2(5000f, 0f);
                bknightImg.gameObject.GetComponent<RectTransform>().anchoredPosition += new Vector2(5000f, 0f);
                bqueenImg.gameObject.GetComponent<RectTransform>().anchoredPosition += new Vector2(5000f, 0f);

                StartCoroutine(SpriteAnim("in", PawnBG));
                StartCoroutine(ImgAnim("in", bbishopImg.GetComponent<Image>()));
                StartCoroutine(ImgAnim("in", brookImg.GetComponent<Image>()));
                StartCoroutine(ImgAnim("in", bknightImg.GetComponent<Image>()));
                StartCoroutine(ImgAnim("in", bqueenImg.GetComponent<Image>()));
                ...
                StartCoroutine(ImgAnim("out", bbishopImg.GetComponent<Image>()));
                StartCoroutine(ImgAnim("out", brookImg.GetComponent<Image>()));
                StartCoroutine(ImgAnim("out", bknightImg.GetComponent<Image>()));
                StartCoroutine(ImgAnim("out", bqueenImg.GetComponent<Image>()));
                yield return new WaitForSeconds(0.5f);
        ...
        if (GetCurrentPlayer() == "white")
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                if (GetPosition(i, 7) != null && GetPosition(i, 7).name == "whitePawn") caller = GetPosition(i, 7).GetComponent<ChessPiece>();
            }
        ...
        {
            kings[i].GetComponent<ChessPiece>().inCheck = false;
            if (IsInCheck(kings[i].GetComponent<ChessPiece>().GetXBoard(), kings[i].GetComponent<ChessPiece>().GetYBoard(), positions)) kings[i].GetComponent<ChessPiece>().inCheck = true;
        }
        IsCheckMate();
    }
    ...
    public bool CheckCheck(ChessPiece caller, int x, int y, string type, GameObject[,] board)
    {
    ...
    {
        ChessPiece callerScript;
        if (board[x, y] != null) callerScript = board[x, y].GetComponent<ChessPiece>();
    ...
    public void IsCheckMate()
    {
        ...
        for (int i = 0; i < kings.Count; i++)
        {
            if (kings[i].GetComponent<ChessPiece>().inCheck)
            {
                ...
                ChessPiece kingScript = kings[i].GetComponent<ChessPiece>();
                ...
                if (PositionOnBoard(x + 1, y + 1) && GetPosition(x + 1, y + 1) != null && GetPosition(x + 1, y + 1).GetComponent<ChessPiece>().player == kingScript.player) check1 = true;
                if (PositionOnBoard(x + 1, y + 0) && GetPosition(x + 1, y + 0) != null && GetPosition(x + 1, y + 0).GetComponent<ChessPiece>().player == kingScript.player) check2 = true;
                if (PositionOnBoard(x + 1, y - 1) && GetPosition(x + 1, y - 1) != null && GetPosition(x + 1, y - 1).GetComponent<ChessPiece>().player == kingScript.player) check3 = true;
                if (PositionOnBoard(x + 0, y - 1) && GetPosition(x + 0, y - 1) != null && GetPosition(x + 0, y - 1).GetComponent<ChessPiece>().player == kingScript.player) check4 = true;
                if (PositionOnBoard(x - 1, y - 1) && GetPosition(x - 1, y - 1) != null && GetPosition(x - 1, y - 1).GetComponent<ChessPiece>().player == kingScript.player) check5 = true;
                if (PositionOnBoard(x - 1, y + 0) && GetPosition(x - 1, y + 0) != null && GetPosition(x - 1, y + 0).GetComponent<ChessPiece>().player == kingScript.player) check6 = true;
                if (PositionOnBoard(x - 1, y + 1) && GetPosition(x - 1, y + 1) != null && GetPosition(x - 1, y + 1).GetComponent<ChessPiece>().player == kingScript.player) check7 = true;
                if (PositionOnBoard(x + 0, y + 1) && GetPosition(x + 0, y + 1) != null && GetPosition(x + 0, y + 1).GetComponent<ChessPiece>().player == kingScript.player) check8 = true;
                ...
                if (kingScript.player == "white")
                {
                    for (int other = 0; other < playerWhite.Length; other++)
                    {
                        ...
                        {
                            ChessPiece caller = playerWhite[other].GetComponent<ChessPiece>();
                ...
                else
                {
                    for (int other = 0; other < playerBlack.Length; other++)
                    {
                        ...
                        {
                            ChessPiece caller = playerBlack[other].GetComponent<ChessPiece>();
                            int xOther = caller.GetXBoard();
                            int yOther = caller.GetYBoard();
                ...
                {
                    if (kings[i].GetComponent<ChessPiece>().player == "white")
                    {
                        Winner("BLACK");
                    }
                    if (kings[i].GetComponent<ChessPiece>().player == "black")
                    {
                        Winner("WHITE");
                    }
                }
    ...
    public bool IsLegalMove(ChessPiece toMove, int xDest, int yDest, ChessPiece king, ChessPiece toMove2, int xDest2, int yDest2)
    {
        GameObject[,] tempPositions = new GameObject[8, 8];
